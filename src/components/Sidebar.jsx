...
import { AnalyticsIcon, AppearanceIcon, ArrowDown, AudienceIcon, DeliveryIcon, DiscountIcon, HomeIcon, MarketingSpeakerIcon, OrderIcon, PayoutIcon , PluginIcon, ProductIcon } from '../../public/assests/Allicons'
...
const Sidebar = () => {
  ...
  return (
    <div className = 'hidden tablet:block  text-white bg-[#1e2640]   gap-6  py-4 px-[10px] '>
