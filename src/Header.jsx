...
import { MagnifyingGlass } from '../public/assests/icons'

const Header = ({setmenubutton,menubutton}) => {
  return (
    <>
      <div className = 'z-0 w-full tablet:grow  bg-[#FAFAFA]'>
                 <div className='p-2 grid grid-cols-2 justify-between bg-[#ffff] border-b-[1px] border-[#d9d9d9] '>

                   {/*  main buttons  hamburger  */}
